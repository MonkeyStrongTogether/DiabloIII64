...
const size_t VERSION_NUMBER     = 0x02329498; //This is actually in a struct having stuff like ChallengeRiftNumber which you can change to get the `newest` CR build or older Challenge Rifts
